...
namespace T8Api.Controllers
{
    ...
    {
        private readonly DmqContext _context;

        public CountriesController(DmqContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<CountryPopulation>> GetCountryPopulation(int id)
        {
            ...
            int cityPopulation = _context.Cities.Where(x=> x.Countryid == id).Select(x=> x.Population).Sum();
